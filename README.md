...
A unified web portal featuring Rogers AI Chat, Pi Singer, Oscilloscope, and Simple 3D tools - all in one beautiful interface.
...
- `portal.html` - Static standalone version (GitHub Pages)
- `infinity_portal.py` - Flask server version (local hosting)
- `index.html` - Launcher page with multiple apps
...
- Flask backend (optional, for Python version)
